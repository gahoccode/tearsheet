...
1. Review current documentation status:
   - Check `docs/architecture/02-architecture-overview.md` for overall project architecture
   - Check `docs/architecture/08-architecture-decisions.md` for project architectural decisions
   - Check `docs/architecture/05-data-architecture.md` for project data models
   - Read other file if neccessary in `docs/architecture/`
...
- UPDATE existing files in the `docs/` directory
